#ifndef THIRD_PARTY_DNG_SDK_SOURCE_RAWENVIRONMENT_H_
#define THIRD_PARTY_DNG_SDK_SOURCE_RAWENVIRONMENT_H_
...
#endif  // THIRD_PARTY_DNG_SDK_SOURCE_RAWENVIRONMENT_H_
